...
public abstract class HH_Runner_Visual {
  ...
  /**
   * Transforms the best solution found, represented as a TSPSolution, into an ordering of
   * Location's which the visualiser tool uses to draw the tour.
   */
  ...
  /**
   * Allows a general visualiser runner by making the HyperHeuristic abstract. You can sub-class
   * this class to run any hyper-heuristic that you want.
   */
